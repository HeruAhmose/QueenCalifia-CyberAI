...
def main() -> int:
    ...
    print(
        ...
        "off-host backup, Render historical-source disposition, final Valkey PKI, live Valkey authority, and final-host manual-control "
        "evidence contracts clean; production authorization readiness remains explicitly fail-closed"
    )
    return 0
